...
import "@/app/assets/styles/muscles.css";

const MusclePlan: React.FC<{
    active: string[];
}> = ({ active }) => {
    return (
        <div className="flex justify-center 2xl:flex-nowrap w-full px-10 gap-x-2 container">
            <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-w-[300px] mc:h-[700px] 2xl:h-[90vh] 3xl:h-[95vh] 4xl:h-screen sm:mx-auto object-fit menor guy">
                <defs>
                ...
                <g id="calves" className="bodymap" style={Array.isArray(active) && active.includes("calves") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="quads" className="bodymap" style={Array.isArray(active) && active.includes("quads") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="abdominals" className="bodymap" style={Array.isArray(active) && active.includes("abdominals") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="obliques" className="bodymap" style={Array.isArray(active) && active.includes("obliques") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="hands" className="bodymap" style={Array.isArray(active) && active.includes("hands") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="forearms" className="bodymap" style={Array.isArray(active) && active.includes("forearms") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g className="bodymap" style={Array.isArray(active) && active.includes("biceps") ? { color: "#ff6868" } : {}} id="biceps">
                    <path
                ...
                <g id="front-shoulders" className="bodymap" style={Array.isArray(active) && active.includes("front-shoulders") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                id="chest" 
                className="bodymap" 
                style={Array.isArray(active) && active.includes("chest") ? { color: "#ff6868" } : {}}
                >
                    <path
                ...
                <g id="traps" className="bodymap" style={Array.isArray(active) && active.includes("traps") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="body" className="body-map__model">
                    <line x1="330.4" y1="504.57" x2="330.4" y2="571.92" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></line>
                    <line x1="330.17" y1="504.57" x2="330.17" y2="571.92" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></line>
                    <line x1="330.05" y1="504.57" x2="330.05" y2="571.92" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></line>
                    <path d="M29,521.95v.02c1.13,7.67,5.05,13.92,10.29,16.59,4.74,2.41,10.96,2.08,17.03-.58" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M165.89,397.13c-18.42,22.99-34.28,22.87-41.87,19.05-12.72-6.41-19.87-27.43,3.8-80.98,0-.02,0-.05.02-.07" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M163.96,299.82h.04" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                    ...
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M289.56,162.48v37.06c0,11.68-7.04,15.63-17.89,19.34-.54.18-1.1.36-1.67.52" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M286.4,377c14.08-4.19,23.65-6.71,37.6-6.43,6.05-.02,6.05-9.08,6.05-18.86" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M289.13,423.26c15.66.26,30.17.65,37.75-3.74,4.67-2.71,3.17-10.45,3.17-19.61" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M290.63,471.07c14.49.53,17.46,1.59,31.05,1.19,7.24-.55,8.38-3.7,8.38-19.3" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M298.53,379.04c4.89-1.29,14.76-4.25,22.72-2.87,7.97,1.39,8.8,6.57,8.8,12.58" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M298.53,428.4c6.43-.76,15.03-1.74,22.89-1.63,7.86.11,8.64,5.42,8.64,13.89" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <line x1="330.29" y1="504.57" x2="330.29" y2="571.92" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></line>
                    <path d="M298.53,477.34c5.89-.13,21.17,1.39,26.59,2.64,5.42,1.26,5.16,8.06,5.16,13.98" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M229.53,518.28c19.21,4.08,52.48,20.12,65.45,64.94,12.97,44.82,19.66,61.4,35.08,61.4" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M206.28,783.67c5.85,26.98,7.58,56.74,28.95,46.03,13.1-6.59,2.82,30.89,26.81,31.31,23.99.41,31.22-52.55,31.22-52.55" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M273.39,881.54c-.16.29-.32.56-.46.83-15.13,26.11-38.4,28.46-48.59,9.57-4.85-8.96-7.91-12.75-15.04-14.45" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <line x1="330.05" y1="504.57" x2="330.05" y2="571.92" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></line>
                    <line x1="330.29" y1="504.57" x2="330.29" y2="571.92" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></line>
                    <line x1="330.4" y1="504.57" x2="330.4" y2="571.92" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></line>
                    <path d="M631.46,521.95v.02c-1.13,7.67-5.05,13.92-10.29,16.59-4.74,2.41-10.96,2.08-17.03-.58" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M494.57,397.13c18.42,22.99,34.28,22.87,41.87,19.05,12.72-6.41,19.87-27.43-3.8-80.98,0-.02,0-.05-.02-.07" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M496.5,299.82h-.04" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                    ...
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M370.9,162.48v37.06c0,11.68,7.04,15.63,17.89,19.34.54.18,1.1.36,1.67.52" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M374.06,377c-14.08-4.19-23.65-6.71-37.6-6.43-6.05-.02-6.05-9.08-6.05-18.86" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M371.33,423.26c-15.66.26-30.17.65-37.75-3.74-4.67-2.71-3.17-10.45-3.17-19.61" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M369.83,471.07c-14.49.53-17.46,1.59-31.05,1.19-7.24-.55-8.38-3.7-8.38-19.3" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M361.93,379.04c-4.89-1.29-14.76-4.25-22.72-2.87-7.97,1.39-8.8,6.57-8.8,12.58" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path d="M361.93,428.4c-6.43-.76-15.03-1.74-22.89-1.63-7.86.11-8.64,5.42-8.64,13.89" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <line x1="330.17" y1="504.57" x2="330.17" y2="571.92" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></line>
                    <path d="M361.93,477.34c-5.89-.13-21.17,1.39-26.59,2.64-5.42,1.26-5.16,8.06-5.16,13.98" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M430.93,518.28c-19.21,4.08-52.48,20.12-65.45,64.94-12.97,44.82-19.66,61.4-35.08,61.4" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M387.07,881.54c.16.29.32.56.46.83,15.13,26.11,38.4,28.46,48.59,9.57,4.85-8.96,7.91-12.75,15.04-14.45" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M15.74,636.36s8.45,1.08,7.1-7.4c-1.35-8.48.36-10.41.19-18.76-.17-8.34,6.15-8.33,4.52-24.4" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                        ...
                        strokeWidth="3.46"
                    ></path>
                    <path d="M644.72,636.36s-8.45,1.08-7.1-7.4c1.35-8.48-.36-10.41-.19-18.76s-6.15-8.33-4.52-24.4" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    <path
                    ...
                    ></path>
                    <g>
                        <path d="M370.84,135.77s-10.57,20.48-40.26,25.91" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                        <path d="M289.97,135.77s10.57,20.48,40.26,25.91" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
                    </g>
                    <path
            ...
            <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-w-[300px] mc:h-[700px] 2xl:h-[90vh] 3xl:h-[95vh] 4xl:h-screen sm:mx-auto object-fit menor guy">
                ...
                <g id="hamstrings" className="bodymap" style={Array.isArray(active) && active.includes("hamstrings") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="glutes" className="bodymap" style={Array.isArray(active) && active.includes("glutes") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="triceps" className="bodymap" style={Array.isArray(active) && active.includes("triceps") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="lats" className="bodymap" style={Array.isArray(active) && active.includes("lats") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="lowerback" className="bodymap" style={Array.isArray(active) && active.includes("lowerback") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="traps-middle" className="bodymap" style={Array.isArray(active) && active.includes("traps-middle") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="rear-shoulders" className="bodymap" style={Array.isArray(active) && active.includes("rear-shoulders") ? { color: "#ff6868" } : {}}>
                    <path
                ...
                <g id="body" className="body-map__model">
                    <path d="M266.34,935.47c-.89-19.84-16.47-25.12-28.26-16.43-14.11,10.4-36.12-39.53-43.56-12.29" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M17.22,535.8c2.09,7.99,6.55,13.88,11.67,15.84,4.99,1.91,12,.65,18.85-3.56" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M102.63,368.78c-11.91,35.01,10.78,12.73,19.35,18,8.73,5.36-8.23,50.09,34.96,11.52" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M223.86,211.87c23.48-.79,35.4,13.24,40.81,19.16,12.57,13.74,20.72.94,65.59.94" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M264.67,231.03c52.5,96.35,51.77,138.65,65.59,138.65" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M146.43,292.74s7.92-6.67,16.02-7.1c8.1-.43,32.12-.43,50.22-15.45,18.1-15.01,34.72-25.92,50.42-40.9" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path
                        ...
                        strokeWidth="3.52"
                    ></path>
                    <path d="M199.54,339.06c7.74-12.38-13.12-52.58,0-60.72" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path
                        ...
                        strokeWidth="3.52"
                    ></path>
                    <path d="M203,791.63s13.43,96.36,35.71,40.85c22.28-55.5-1.29,32.07,27.64,32.07,13.1,0,21.17-19.38,28.81-70.69" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path
                        ...
                        strokeWidth="3.52"
                    ></path>
                    <path d="M394.18,935.47c.89-19.84,16.47-25.12,28.26-16.43,14.11,10.4,36.12-39.53,43.56-12.29" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M643.3,535.8c-2.09,7.99-6.55,13.88-11.67,15.84-4.99,1.91-12,.65-18.85-3.56" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M557.89,368.78c11.91,35.01-10.78,12.73-19.35,18-8.73,5.36,8.23,50.09-34.96,11.52" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M390.56,191.86c-21.92-5.91-45.38-4.01-55.35-3.59-3.3.14-6.59.14-9.89,0-9.98-.42-33.44-2.32-55.35,3.59" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M436.66,211.87c-23.48-.79-35.4,13.24-40.81,19.16-12.57,13.74-20.72.94-65.59.94" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M395.85,231.03c-52.5,96.35-51.77,138.65-65.59,138.65" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path d="M514.09,292.74s-7.92-6.67-16.02-7.1c-8.1-.43-32.12-.43-50.22-15.45-18.1-15.01-34.72-25.92-50.42-40.9" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path
                        ...
                        strokeWidth="3.52"
                    ></path>
                    <path d="M460.98,339.06c-7.74-12.38,13.12-52.58,0-60.72" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path
                        d="M330.26,614.06c0,35.81,24.38,31.69,49.78,30.16,27.16-1.64,63.32-19.3,43.62-80.18-8.85-27.35-8.53-46.89-35.82-54.97-19.3-5.72-57.58-4.57-57.58,44.65"
                        fill="none"
                        stroke="#484a68"
                        ...
                        strokeWidth="3.52"
                    ></path>
                    <path d="M457.52,791.63s-13.43,96.36-35.71,40.85c-22.28-55.5,1.29,32.07-27.64,32.07-13.1,0-21.17-19.38-28.81-70.69" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path
                        ...
                        strokeWidth="3.52"
                    ></path>
                    <line x1="330.26" y1="553.71" x2="330.26" y2="614.06" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></line>
                    <path
                        ...
                        strokeWidth="3.52"
                    ></path>
                    <path d="M29.74,645.19s8.31-5.16,2.87-13.06c-4.55-6.58-5.28-6.14-2.87-15.29,1.87-7.08.7-12.38,3.36-17.5" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <path
                        ...
                        strokeWidth="3.52"
                    ></path>
                    <path d="M630.78,645.19s-8.31-5.16-2.87-13.06c4.55-6.58,5.28-6.14,2.87-15.29-1.87-7.08-.7-12.38-3.36-17.5" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
                    <g>
                        <path
